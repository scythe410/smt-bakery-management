...
// Ingredient-audit error boundary (DESIGN.md §6): state what happened and the fix,
// with a retry — no apology, no spinner. Client component (error boundaries must be).
